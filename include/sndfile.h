...
SNDFILE_EXPORT SNDFILE* 	sf_open		(const char *path, int mode, SF_INFO *sfinfo) ;
...
SNDFILE_EXPORT SNDFILE* 	sf_open_fd	(int fd, int mode, SF_INFO *sfinfo, int close_desc) ;

SNDFILE_EXPORT SNDFILE* 	sf_open_virtual	(SF_VIRTUAL_IO *sfvirtual, int mode, SF_INFO *sfinfo, void *user_data) ;
...
SNDFILE_EXPORT int		sf_error		(SNDFILE *sndfile) ;
...
SNDFILE_EXPORT const char* sf_strerror (SNDFILE *sndfile) ;
...
SNDFILE_EXPORT const char*	sf_error_number	(int errnum) ;
...
SNDFILE_EXPORT int		sf_perror		(SNDFILE *sndfile) ;
SNDFILE_EXPORT int		sf_error_str	(SNDFILE *sndfile, char* str, size_t len) ;


/* Return TRUE if fields of the SF_INFO struct are a valid combination of values. */

SNDFILE_EXPORT int		sf_command	(SNDFILE *sndfile, int command, void *data, int datasize) ;


/* Return TRUE if fields of the SF_INFO struct are a valid combination of values. */

SNDFILE_EXPORT int		sf_format_check	(const SF_INFO *info) ;
...
SNDFILE_EXPORT sf_count_t	sf_seek 		(SNDFILE *sndfile, sf_count_t frames, int whence) ;
...
SNDFILE_EXPORT int sf_set_string (SNDFILE *sndfile, int str_type, const char* str) ;

SNDFILE_EXPORT const char* sf_get_string (SNDFILE *sndfile, int str_type) ;


/* Return the library version string. */

SNDFILE_EXPORT const char * sf_version_string (void) ;
...
*/
SNDFILE_EXPORT int sf_current_byterate (SNDFILE *sndfile) ;

/* Functions for reading/writing the waveform data of a sound file.
*/

SNDFILE_EXPORT sf_count_t	sf_read_raw		(SNDFILE *sndfile, void *ptr, sf_count_t bytes) ;
SNDFILE_EXPORT sf_count_t	sf_write_raw 	(SNDFILE *sndfile, const void *ptr, sf_count_t bytes) ;
...
SNDFILE_EXPORT sf_count_t	sf_readf_short	(SNDFILE *sndfile, short *ptr, sf_count_t frames) ;
SNDFILE_EXPORT sf_count_t	sf_writef_short	(SNDFILE *sndfile, const short *ptr, sf_count_t frames) ;

SNDFILE_EXPORT sf_count_t	sf_readf_int	(SNDFILE *sndfile, int *ptr, sf_count_t frames) ;
SNDFILE_EXPORT sf_count_t	sf_writef_int 	(SNDFILE *sndfile, const int *ptr, sf_count_t frames) ;

SNDFILE_EXPORT sf_count_t	sf_readf_float	(SNDFILE *sndfile, float *ptr, sf_count_t frames) ;
SNDFILE_EXPORT sf_count_t	sf_writef_float	(SNDFILE *sndfile, const float *ptr, sf_count_t frames) ;

SNDFILE_EXPORT sf_count_t	sf_readf_double		(SNDFILE *sndfile, double *ptr, sf_count_t frames) ;
SNDFILE_EXPORT sf_count_t	sf_writef_double	(SNDFILE *sndfile, const double *ptr, sf_count_t frames) ;
...
SNDFILE_EXPORT sf_count_t	sf_read_short	(SNDFILE *sndfile, short *ptr, sf_count_t items) ;
SNDFILE_EXPORT sf_count_t	sf_write_short	(SNDFILE *sndfile, const short *ptr, sf_count_t items) ;

SNDFILE_EXPORT sf_count_t	sf_read_int		(SNDFILE *sndfile, int *ptr, sf_count_t items) ;
SNDFILE_EXPORT sf_count_t	sf_write_int 	(SNDFILE *sndfile, const int *ptr, sf_count_t items) ;

SNDFILE_EXPORT sf_count_t	sf_read_float	(SNDFILE *sndfile, float *ptr, sf_count_t items) ;
SNDFILE_EXPORT sf_count_t	sf_write_float	(SNDFILE *sndfile, const float *ptr, sf_count_t items) ;

SNDFILE_EXPORT sf_count_t	sf_read_double	(SNDFILE *sndfile, double *ptr, sf_count_t items) ;
SNDFILE_EXPORT sf_count_t	sf_write_double	(SNDFILE *sndfile, const double *ptr, sf_count_t items) ;
...
SNDFILE_EXPORT int		sf_close		(SNDFILE *sndfile) ;
...
SNDFILE_EXPORT void	sf_write_sync	(SNDFILE *sndfile) ;
...
SNDFILE_EXPORT SNDFILE* sf_wchar_open (LPCWSTR wpath, int mode, SF_INFO *sfinfo) ;
#endif
...
*/
SNDFILE_EXPORT int sf_set_chunk (SNDFILE * sndfile, const SF_CHUNK_INFO * chunk_info) ;
...
** sf_close() is called.
*/
SNDFILE_EXPORT SF_CHUNK_ITERATOR *
